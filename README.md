...
> — **Melvin / Melhub**
> # 💫 About Me:
# 👋 Hey, I’m Melvin — aka [Melhub](https://melhub.netlify.app)<br><br>## 🔧 Full-Stack Developer • AI Integrator • Builder of Bold Ideas<br><br>I'm a solo developer who codes with vision, vibes, and velocity.  <br>Whether it’s shipping SaaS tools, crafting AI-powered apps, or hacking together games that spark curiosity — I *build fast*, *break limits*, and *learn even faster*.<br><br>---<br><br>### 🚀 What I Build<br><br>- 🔮 **AI Tools** — Dream interpreters, content generators, social AI assistants<br>- 🧩 **SaaS Apps** — Automation-first tools that solve real problems<br>- 🎮 **Games** — Experimental games with dark twists and survival mechanics<br>- 🧠 **Vibe Coding** — I architect apps using AI as my co-pilot. It’s not just coding — it’s orchestration.<br><br>---<br><br>### 🧵 Featured Projects<br>- 🧠 **Dream Interpreter & Manifestation Coach**  <br>  NLP-powered dream decoding + daily affirmations. A spiritual tech blend for the TikTok generation.<br><br>- 🤖 **AI Caption Generator**  <br>  Automates social media captions with trend-aware GPT prompts and style presets.<br><br>- 🕹️ **Would You Rather: Survival Edition**  <br>  A dark, eerie decision game where every round gets creepier and harder to survive.<br><br>---<br><br>### 📫 Let’s Connect<br><br>- 🌐 **Portfolio** → [melvinworks.netlify.app](https://melvinworks.netlify.app)  <br>  Peek into my projects, past work, and creative builds.<br><br>- 🔗 **Socials Hub** → [melhub.netlify.app](https://melhub.netlify.app)  <br>  One link to find them all — GitHub, Twitter, YouTube, LinkedIn, and more.<br><br>- 💬 Always open to collabs, freelancing, or just a good dev chat.<br><br>---<br><br>### ⚡ Tech Stack<br><br>`React` `Vite` `Firebase` `Supabase` `Turso` `Python` `GPT-4o` `Tailwind CSS` `Node.js` `Netlify` `Framer Motion` `Stripe` `Figma`<br><br>---<br><br>> ✨ *Building in public, dreaming big, and coding with intention.*  <br>> — **Melvin / Melhub**<br><br>
